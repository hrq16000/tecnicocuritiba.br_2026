    ...
    "faq": [
      {
        ...
        "answer": "Depende de onde a falha está. Quando a origem é conexão do painel, cabo flat ou placa de controle da imagem, o reparo costuma ser viável e o aparelho volta com imagem normal. Quando o dano está dentro da matriz do painel, não há reparo possível — e trocar o painel raramente compensa diante do valor de um televisor novo. Por isso a avaliação em bancada vem antes de qualquer orçamento: é ela que separa os dois mundos."
      },
      {
