...
export const BAIRROS_INDEXAVEIS: Record<string, BairroContext> = {
  ...
  "cristo-rei": {
    ...
    narrativaLocal:
      "Cristo Rei tem uma característica que muda o nosso roteiro técnico: a convivência entre casas antigas de laje, edifícios de médio porte e uma população flutuante grande por causa do campus Politécnico da UFPR e das clínicas da Avenida Sete de Setembro. Em república e kitnet alugada por estudante, o cenário mais comum é um único roteador da operadora colocado na sala, alimentado por régua compartilhada com micro-ondas e forno elétrico, servindo quatro ou cinco pessoas que assistem aula on-line ao mesmo tempo. Nessas casas, medimos a taxa real por cômodo antes de sugerir qualquer compra: em boa parte dos atendimentos, apenas reposicionar o equipamento, separar as bandas com nomes diferentes e limitar dispositivos legados que forçam a rede a operar em modo antigo já devolve estabilidade nas videochamadas. Quando há laje de concreto entre pavimentos, preferimos ponto de acesso cabeado no piso superior a repetidor sem fio, porque o repetidor divide a banda e piora justamente o que o morador quer melhorar. Nos consultórios e escritórios técnicos do bairro, o trabalho é outro: separar a rede de prontuário eletrônico e maquininha do Wi-Fi de sala de espera, documentar senhas e deixar o roteamento previsível para quem dá suporte remoto ao sistema clínico. Na frente de televisores, Cristo Rei nos traz muitos aparelhos de 43 a 55 polegadas com cinco a dez anos de uso, ligados em salas de estudo com iluminação forte, o que leva o usuário a manter brilho no máximo e acelerar o desgaste do conjunto de LEDs. Recebemos com frequência telas que acendem por um instante e apagam, sinal clássico de proteção da fonte disparando por barra queimada. Fazemos a coleta no endereço, medimos tensão de acionamento em bancada, trocamos apenas as barras defeituosas quando isso é tecnicamente seguro e submetemos o aparelho a teste prolongado antes de devolver. Todo valor do reparo sai por escrito no WhatsApp, com peça, prazo e garantia definidos antes de qualquer execução.",
    indexable: true,
  },
  cajuru: {
    slug: "cajuru",
    ...
    narrativaLocal:
      "O Cajuru é um bairro de casas térreas e sobrados construídos em lotes compridos, muitas vezes com edícula nos fundos, e essa geometria explica quase todos os chamados de Wi-Fi que atendemos por aqui. O roteador da operadora costuma ficar instalado onde o cabo entrou, normalmente na frente do imóvel, e o morador precisa de sinal a vinte ou trinta metros de distância, atravessando paredes de tijolo maciço, portão metálico e às vezes uma laje. Nesse cenário, repetidor sem fio raramente resolve: preferimos levar cabo de rede pelo forro ou por conduíte externo com proteção ultravioleta e instalar um ponto de acesso dedicado nos fundos, criando uma única rede com transição automática entre os equipamentos. Quando o cliente não quer obra, avaliamos enlace por rádio de curto alcance ou adaptadores de rede pela fiação elétrica, sempre medindo antes para não vender promessa que a instalação não sustenta. Também é comum na região a rede compartilhada entre duas famílias no mesmo terreno; nesses casos configuramos redes separadas com controle de banda para que o consumo de um lado não derrube o outro. Na parte de televisores, o Cajuru concentra aparelhos de uso intensivo em salas de convivência familiar, com muitas horas diárias ligados e alimentação elétrica sujeita a oscilações da rede local. Isso produz um padrão de defeito bem definido no nosso histórico: fonte com capacitores estufados, placa de alimentação com trilha corroída por umidade e módulos de conectividade que travam depois de queda de energia. Coletamos o aparelho na residência sem custo quando o serviço aprovado passa de uma hora de bancada, avaliamos com relatório fotográfico e apresentamos comparação sincera entre reparar e substituir, sem empurrar troca de placa quando o reparo pontual resolve. Depois da devolução, orientamos sobre estabilizador adequado, ventilação do móvel e limpeza periódica, medidas simples que reduzem bastante a reincidência nas casas do bairro.",
    indexable: true,
  },
  boqueirao: {
    slug: "boqueirao",
    ...
    narrativaLocal:
      "Boqueirão é um dos maiores bairros de Curitiba em população e mistura residências amplas, comércio de rua consolidado e pequenas indústrias familiares, o que gera demandas de rede muito diferentes em endereços que ficam a poucas quadras um do outro. Em casas de dois pavimentos com quintal e churrasqueira coberta, o pedido recorrente é levar sinal estável até a área de lazer e até câmeras instaladas no muro dos fundos; nesses projetos usamos ponto de acesso externo com alimentação por cabo de rede, separando o tráfego das câmeras do uso doméstico para que a gravação contínua não engasgue as transmissões de vídeo da família. No comércio da Avenida Marechal Floriano, o foco muda para continuidade operacional: caixa, emissão fiscal, maquininha e sistema de estoque não podem cair no horário de pico, então priorizamos cabeamento até os pontos críticos e deixamos o Wi-Fi apenas para clientes e tarefas secundárias, com senha rotativa e limite de banda. Também revisamos aterramento e proteção contra surtos, porque muitos pontos comerciais do bairro operam com instalações elétricas antigas e queimam equipamento de rede com frequência. Nos serviços de imagem, o perfil típico do Boqueirão é o televisor grande de sala usado o dia inteiro, além de aparelhos secundários em cozinha e quarto. Recebemos muitos casos de tela com som e sem imagem, listras horizontais e desligamento aleatório, defeitos que investigamos em bancada com fonte controlada e teste térmico antes de indicar peça. Nossa regra é simples e vale para todo o bairro: diagnóstico registrado, valor aprovado antes de executar, peças descritas na entrega e garantia contada em dias corridos sobre o serviço realizado. Como não atendemos presencialmente em loja, todo o fluxo acontece com coleta e entrega no endereço combinado, o que evita deslocamento do cliente e permite agendar em horário compatível com o funcionamento da casa ou do comércio.",
    indexable: true,
  },
  "jardim-das-americas": {
