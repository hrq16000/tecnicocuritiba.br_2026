...
export const CURATED_DYNAMIC_HEAD: Record<string, RouteHeadInput> = {
    ...
    "faq": [
      {
        ...
        "answer": "Sim. O backup é etapa obrigatória e é conferido antes da formatação. Se o disco estiver com falha física, avisamos antes de prosseguir."
      },
      {
        "question": "Quanto tempo leva a formatação?",
        "answer": "Depende do volume de dados e do estado do disco. A janela estimada é confirmada na triagem, sem promessa de prazo fechado."
      },
      {
        "question": "O atendimento no CIC é em casa ou com coleta?",
        "answer": "Quando a máquina liga e funciona, a formatação costuma caber em visita. Se houver falha de disco ou necessidade de bancada, convertemos em coleta e entrega."
      },
      {
        "question": "O serviço tem garantia?",
        "answer": "Sim, a mão de obra tem garantia registrada por escrito. Peças seguem a garantia do fornecedor."
      }
    ]
  },
  "/servicos/formatacao-computador/batel": {
    ...
    "faq": [
      ...
      {
        "question": "O atendimento no Batel é em casa ou com coleta?",
        "answer": "Quando a máquina liga e funciona, a formatação costuma caber em visita. Se houver falha de disco ou necessidade de bancada, convertemos em coleta e entrega."
      },
      {
        "question": "O serviço tem garantia?",
  ...
  "/servicos/formatacao-computador/agua-verde": {
    ...
    "faq": [
      ...
      {
        "question": "O atendimento no Água Verde é em casa ou com coleta?",
        "answer": "Quando a máquina liga e funciona, a formatação costuma caber em visita. Se houver falha de disco ou necessidade de bancada, convertemos em coleta e entrega."
      },
      {
        "question": "O serviço tem garantia?",
  ...
  "/servicos/formatacao-computador/jardim-das-americas": {
    ...
    "faq": [
      ...
      {
        "question": "O atendimento no Jardim das Américas é em casa ou com coleta?",
        "answer": "Quando a máquina liga e funciona, a formatação costuma caber em visita. Se houver falha de disco ou necessidade de bancada, convertemos em coleta e entrega."
      },
      {
        "question": "O serviço tem garantia?",
  ...
  "/servicos/formatacao-computador/ecoville": {
    ...
    "faq": [
      ...
      {
        "question": "O atendimento no Ecoville é em casa ou com coleta?",
        "answer": "Quando a máquina liga e funciona, a formatação costuma caber em visita. Se houver falha de disco ou necessidade de bancada, convertemos em coleta e entrega."
      },
      {
        "question": "O serviço tem garantia?",
  ...
  "/servicos/formatacao-computador/alto-da-xv": {
    ...
    "faq": [
      ...
      {
        "question": "O atendimento no Alto da XV é em casa ou com coleta?",
        "answer": "Quando a máquina liga e funciona, a formatação costuma caber em visita. Se houver falha de disco ou necessidade de bancada, convertemos em coleta e entrega."
      },
      {
        "question": "O serviço tem garantia?",
  ...
  "/servicos/formatacao-computador/reboucas": {
    ...
    "faq": [
      ...
      {
        "question": "O atendimento no Rebouças é em casa ou com coleta?",
        "answer": "Quando a máquina liga e funciona, a formatação costuma caber em visita. Se houver falha de disco ou necessidade de bancada, convertemos em coleta e entrega."
      },
      {
        "question": "O serviço tem garantia?",
    ...
    "faq": [
      {
        ...
        "answer": "Na maioria dos casos não. A formatação só é recomendada quando a infecção atinge componentes do sistema que não podem ser recuperados com segurança."
      },
      {
        "question": "Tenho antivírus e mesmo assim infectei. Por quê?",
        "answer": "Adware e sequestradores de navegador costumam ser instalados pelo próprio usuário junto de programas gratuitos, e muitos antivírus não bloqueiam esse tipo de instalação."
      },
      {
        "question": "Meus arquivos correm risco durante a limpeza?",
        "answer": "Não removemos documentos pessoais. Quando há risco de perda por dano prévio, avisamos antes e sugerimos backup."
      },
      {
        "question": "Atendem empresas no CIC?",
        "answer": "Sim. Também tratamos estações de trabalho e servidores de arquivo de pequenas e médias empresas."
      }
    ]
  },
  "/servicos/remocao-virus/agua-verde": {
    ...
    "faq": [
      ...
      {
        "question": "Atendem empresas no Água Verde?",
        "answer": "Sim. Também tratamos estações de trabalho e servidores de arquivo de pequenas e médias empresas."
      }
    ]
  },
  "/servicos/remocao-virus/jardim-das-americas": {
    ...
    "faq": [
      ...
      {
        "question": "Atendem empresas no Jardim das Américas?",
        "answer": "Sim. Também tratamos estações de trabalho e servidores de arquivo de pequenas e médias empresas."
      }
    ]
  },
  "/servicos/remocao-virus/ecoville": {
    ...
    "faq": [
      ...
      {
        "question": "Atendem empresas no Ecoville?",
        "answer": "Sim. Também tratamos estações de trabalho e servidores de arquivo de pequenas e médias empresas."
      }
    ]
  },
  "/servicos/remocao-virus/alto-da-xv": {
    ...
    "faq": [
      ...
      {
        "question": "Atendem empresas no Alto da XV?",
        "answer": "Sim. Também tratamos estações de trabalho e servidores de arquivo de pequenas e médias empresas."
      }
    ]
  },
  "/servicos/remocao-virus/reboucas": {
    ...
    "faq": [
      ...
      {
        "question": "Atendem empresas no Rebouças?",
        "answer": "Sim. Também tratamos estações de trabalho e servidores de arquivo de pequenas e médias empresas."
      }
    ]
  },
    ...
    "faq": [
      {
        ...
        "answer": "Sim. Trabalhamos com as principais marcas de notebook e desktop, incluindo montagens personalizadas e máquinas de trabalho."
      },
      {
        "question": "Máquina que não liga é sempre placa queimada?",
        "answer": "Não. Fonte, bateria, botão de energia e memória respondem por boa parte dos casos. Só apontamos placa após medição."
      },
      {
        "question": "O reparo é feito no meu endereço no Centro de Curitiba?",
        "answer": "Reparos simples cabem em visita. Falhas de placa e reparos com bancada exigem coleta, com valor mínimo pré-aprovado e laudo."
      },
      {
        "question": "E se não compensar consertar?",
        "answer": "Apresentamos o comparativo entre reparo e substituição. A decisão é sua, com o laudo em mãos e sem pressão comercial."
      }
    ]
  },
  "/servicos/conserto-pc-notebook/agua-verde": {
    ...
    "faq": [
      ...
      {
        "question": "O reparo é feito no meu endereço no Água Verde?",
        "answer": "Reparos simples cabem em visita. Falhas de placa e reparos com bancada exigem coleta, com valor mínimo pré-aprovado e laudo."
      },
      {
        "question": "E se não compensar consertar?",
  ...
  "/servicos/conserto-pc-notebook/jardim-das-americas": {
    ...
    "faq": [
      ...
      {
        "question": "O reparo é feito no meu endereço no Jardim das Américas?",
        "answer": "Reparos simples cabem em visita. Falhas de placa e reparos com bancada exigem coleta, com valor mínimo pré-aprovado e laudo."
      },
      {
        "question": "E se não compensar consertar?",
  ...
  "/servicos/conserto-pc-notebook/ecoville": {
    ...
    "faq": [
      ...
      {
        "question": "O reparo é feito no meu endereço no Ecoville?",
        "answer": "Reparos simples cabem em visita. Falhas de placa e reparos com bancada exigem coleta, com valor mínimo pré-aprovado e laudo."
      },
      {
        "question": "E se não compensar consertar?",
  ...
  "/servicos/conserto-pc-notebook/alto-da-xv": {
    ...
    "faq": [
      ...
      {
        "question": "O reparo é feito no meu endereço no Alto da XV?",
        "answer": "Reparos simples cabem em visita. Falhas de placa e reparos com bancada exigem coleta, com valor mínimo pré-aprovado e laudo."
      },
      {
        "question": "E se não compensar consertar?",
  ...
  "/servicos/conserto-pc-notebook/reboucas": {
    ...
    "faq": [
      ...
      {
        "question": "O reparo é feito no meu endereço no Rebouças?",
        "answer": "Reparos simples cabem em visita. Falhas de placa e reparos com bancada exigem coleta, com valor mínimo pré-aprovado e laudo."
      },
      {
        "question": "E se não compensar consertar?",
    ...
    "faq": [
      {
        ...
        "answer": "Confirmamos o modelo na triagem. Você também pode fornecer a peça: nesse caso o atendimento cobre apenas a instalação e a migração."
      },
      {
        "question": "Vou perder programas ao trocar por SSD?",
        "answer": "Não. A migração preserva o sistema, os programas e os perfis. A reinstalação limpa só é feita se você preferir."
      },
      {
        "question": "Quanto de memória vale a pena colocar?",
        "answer": "Depende do uso e do que a placa aceita. Indicamos a configuração que traz ganho real, sem empurrar capacidade que o sistema não aproveita."
      },
      {
        "question": "Upgrade resolve qualquer lentidão?",
        "answer": "Não. Disco em falha, superaquecimento e infecção também causam lentidão — por isso o diagnóstico vem antes da indicação de peça."
      }
    ]
  },
