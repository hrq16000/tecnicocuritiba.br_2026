...
export const INTENT_MATRIX = [
  ...
  { path: "/problemas/notebook-desligando-sozinho", keyword: "notebook desligando sozinho", role: "sintoma de desligamento em notebook", notCompeting: ["/problemas/notebook-superaquecendo", "/problemas/notebook-nao-liga", "/problemas/computador-desliga-sozinho", "/servicos/manutencao-de-notebook"] },
  ...
  { path: "/problemas/windows-nao-inicia", keyword: "windows nao inicia", role: "sintoma de sistema operacional que nao carrega", notCompeting: ["/problemas/computador-nao-liga", "/problemas/tela-azul-windows", "/servicos/formatacao", "/servicos/recuperacao-de-dados"] },
  { path: "/problemas/tv-com-imagem-escura", keyword: "tv com imagem escura", role: "sintoma de iluminacao de fundo fraca em tv", notCompeting: ["/problemas/tv-com-som-sem-imagem", "/problemas/tv-nao-liga", "/servicos/conserto-tv", "/servicos/conserto-placa"] },
  ...
  { path: "/problemas/webcam-nao-funciona", keyword: "webcam nao funciona", role: "sintoma de camera integrada sem imagem", notCompeting: ["/servicos/manutencao-de-notebook", "/servicos/manutencao-de-computador", "/problemas/computador-sem-som", "/atendimento-remoto"] },
  { path: "/problemas/tv-nao-conecta-no-wifi", keyword: "tv nao conecta no wifi", role: "sintoma de conexao sem fio em smart tv", notCompeting: ["/problemas/wifi-caindo-toda-hora", "/problemas/notebook-nao-conecta-no-wifi", "/servicos/redes-e-wifi", "/servicos/conserto-tv", "/problemas/tv-travando"] },
