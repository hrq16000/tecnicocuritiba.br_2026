...
export const INTENT_MATRIX = [
  ...
  { path: "/problemas/webcam-nao-funciona", keyword: "webcam nao funciona", role: "sintoma de camera integrada sem imagem", notCompeting: ["/servicos/manutencao-de-notebook", "/servicos/conserto-notebook", "/problemas/computador-sem-som", "/atendimento-remoto"] },
